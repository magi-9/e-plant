    ...
    return (
        <div className="min-h-[70vh] flex items-center justify-center px-4 py-16 bg-slate-50">
            <div className="w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-8 sm:p-10 text-center shadow-sm">
                <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-[#eaf4fe]">
                    <MagnifyingGlassIcon className="h-8 w-8 text-[#1565c0]" />
                </div>
                <p className="text-xs font-semibold tracking-[0.18em] text-[#1565c0] uppercase">404</p>
                ...
                <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
                    <Link
                        to="/"
                        className="inline-flex items-center gap-2 rounded-lg bg-[#2196f3] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#1565c0] transition-colors"
                    >
