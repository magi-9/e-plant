...
export default function VerifyEmailPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col justify-start sm:justify-center pt-8 pb-12 sm:py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <h2 className="mt-2 sm:mt-6 text-center text-3xl font-extrabold text-gray-900">
                    Overenie e-mailu
                </h2>
            </div>
