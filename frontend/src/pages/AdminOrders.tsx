...
const STATUS_COLORS: Record<string, string> = {
    ...
    shipped: 'bg-[#eaf4fe] text-[#1565c0] border-[rgba(33,150,243,0.25)]',
    ...
    if (isLoading) {
        return (
            <div className="flex items-center justify-center min-h-screen bg-slate-50">
                <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-[#2196f3]" />
            </div>
        );
    }
                    ...
                    <div className="grid grid-cols-1 gap-3 md:grid-cols-6">
                        <div className="md:col-span-2">
                            ...
                            <input
                                ...
                                className="mt-1 block w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-[#2196f3] focus:outline-none focus:ring-2 focus:ring-[#2196f3]/30"
                            />
                        </div>
                        <div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    className="block w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm focus:border-[#2196f3] focus:outline-none focus:ring-2 focus:ring-[#2196f3]/30 disabled:opacity-50"
                                                >
                                                    {Object.entries(STATUS_LABELS).map(([key, label]) => (
                                                                    ...
                                                                    {item.batch_allocations?.length > 0 && (
                                                                        <div className="mt-1 flex flex-wrap gap-1">
                                                                            {item.batch_allocations.map((b, i) => (
                                                                                <span key={i} className="inline-flex items-center px-1.5 py-0.5 rounded text-xs bg-[#eaf4fe] text-[#1565c0] border border-[rgba(33,150,243,0.15)]">
                                        ...
                                        <div className="mt-4 bg-white border border-amber-200 rounded-xl p-4">
                                            ...
                                            <div className="mt-4 flex flex-wrap gap-2">
                                                <button
                                                    ...
                                                    className="inline-flex items-center rounded-lg bg-[#2196f3] px-4 py-2 text-sm font-semibold text-white hover:bg-[#1565c0] disabled:opacity-50"
                                                >
                                                    Uložiť zásah
                                                </button>
                                                <button
